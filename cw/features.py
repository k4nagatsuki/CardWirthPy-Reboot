...
def wrap_ability(data):
    ...
    data.aggressive = cw.util.numwrap(data.aggressive, -4, 4)
    data.cheerful = cw.util.numwrap(data.cheerful, -4, 4)
    data.brave = cw.util.numwrap(data.brave, -4, 4)
    data.cautious = cw.util.numwrap(data.cautious, -4, 4)
    data.trickish = cw.util.numwrap(data.trickish, -4, 4)
