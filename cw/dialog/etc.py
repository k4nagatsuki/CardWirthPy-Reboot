...
class BookmarkDialog(wx.Dialog):
    ...
    def __init__(self, parent, scedir, db):
        ...
        self.values.imgidx_summary = self.values.imglist.Add(cw.wins(cw.cwpy.rsrc.dialogs["SUMMARY"]))
        self.values.imgidx_complete = self.values.imglist.Add(cw.wins(cw.cwpy.rsrc.dialogs["SUMMARY_COMPLETE"]))
        self.values.imgidx_playing = self.values.imglist.Add(cw.wins(cw.cwpy.rsrc.dialogs["SUMMARY_PLAYING"]))
        self.values.imgidx_invisible = self.values.imglist.Add(cw.wins(cw.cwpy.rsrc.dialogs["SUMMARY_INVISIBLE"]))
        self.values.imgidx_dir = self.values.imglist.Add(cw.wins(cw.cwpy.rsrc.dialogs["DIRECTORY"]))
