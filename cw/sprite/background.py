...
class BattleCardImage(card.CWPyCard):
    ...
    def update_battlestart(self):
        cw.animation.animate_sprite(self, "deal", 2)
        self.zoomsize = (5, 8)
        cw.animation.animate_sprite(self, "zoomin", 2)
        cw.animation.animate_sprite(self, "hide", 2)
        cw.animation.animate_sprite(self, "deal", 2)
        self.zoomsize = (8, 12)
        cw.animation.animate_sprite(self, "zoomin", 2)
        cw.animation.animate_sprite(self, "hide", 2)
        ...
        self.zoomsize = (16, 24)
        cw.animation.animate_sprite(self, "zoomin", 2)
        waitrate = cw.cwpy.setting.dealspeed * 96
        pygame.time.wait(waitrate)
