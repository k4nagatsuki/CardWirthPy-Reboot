...
class _JpySubImage(cw.image.Image):
    ...
    def drawtemp(self, doanime):
        ...
        # 一時描画
            ...
            # 単一描画
            sprs = cw.cwpy.topgrp.get_sprites_from_layer(cw.LAYER_JPY_TEMPORAL) # TODO: layer
            if sprs:
...
class JpdcImage(cw.image.Image):
    def __init__(self, mask, path, cache=None, defaultcopymode=2, doanime=None):
        ...
        if copymode == 3:
            ...
            if copymode == 2:
                for sprite in cw.cwpy.topgrp.get_sprites_from_layer(cw.LAYER_JPY_TEMPORAL): # TODO: layer
