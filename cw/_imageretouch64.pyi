...
"""
def blend_add_1_50(buf: bytes, size: Tuple[int, int], sbuf: bytes) -> bytes: ...


"""CardWirth 1.50の挙動に合わせて減算合成を行う。
"""
def blend_sub_1_50(buf: bytes, size: Tuple[int, int], sbuf: bytes) -> bytes: ...


"""CardWirth 1.50の挙動に合わせて乗算合成を行う。
"""
def blend_mult_1_50(buf: bytes, size: Tuple[int, int], sbuf: bytes) -> bytes: ...
