 ...
 * ＠CardWirthPy Version.3.1
 * ＠CardWirthPy Version.3.1 Only

このうち、「Only」がついている称号は、CardWirthPyのバージョンアップ時に削除され、新しいバージョン固有の称号に差し替えられます。「Only」がついていない称号は、バージョンアップ後も残ります。

CardWirthPyでプレイ中か判定する時やバージョンが3.1以降であるか判定する時には、「＠CardWirthPy Version.3.1」を使用して称号判定分岐を行ってください。

CardWirthPy 3.1固有で将来修正される見込みのバグに対処したい場合などは、「＠CardWirthPy Version.3.1 Only」を使用してください。
