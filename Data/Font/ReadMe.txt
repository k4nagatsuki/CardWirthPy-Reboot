...
CardWirthPyで使用しているフォントのファイルです。
CardWirthPy/Data/Font以下に配置してください。

独立行政法人情報処理推進機構(IPA)により配布されているフォントを
以下のライセンスに従って再配布しています。
...
以下、「受領者」といいます。）が、受領した許諾プログラムをコンピュータ（１条に定義する
